...
<form action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
  ...
  <div class="form-row">
    <div class="form-group col">
      ...
      <small id="account_display_nameHelp" class="form-text text-muted"><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'woocommerce' ); ?></small>
    </div>
    <div class="form-group col">
    ...
    <div class="form-row">
      <div class="form-group">
          <label for="account_vat"><?php //esc_html_e( 'VAT', 'woocommerce' ); ?></label>
          <input type="text" class="form-control" name="account_vat" id="account_vat" autocomplete="false" value="<?php //echo esc_attr( get_field( 'vat_number', $user->ID ) ); ?>" required/>
      </div>
    </div>
  -->
